...
var addToggler = ($collapsible, $toggler) => {
  ...
  if ($collapsible.hasClass("collapsible-next")) {
    ...
    $collapsible.children(".NavHead").first().append($toggler);
