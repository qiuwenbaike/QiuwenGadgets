...
var navFrame = ($content) => {
  ...
  var _iterator9 = _createForOfIteratorHelper($content.find(".NavHead")), _step9;
  try {
  ...
  var _iterator10 = _createForOfIteratorHelper($content.find(".NavContent, .NavPic")), _step10;
  try {
