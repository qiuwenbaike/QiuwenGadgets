...
var translateVariants = (wgPageName) => {
  ...
  const $submitAll = $(/* @__PURE__ */ import_ext_gadget2.default.createElement("button", null, window.wgULS("发布所有更改", "發佈所有變更")));
  $submitAll.on("click", () => {
