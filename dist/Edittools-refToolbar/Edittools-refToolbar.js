...
var refToolbar2 = ($body) => {
  ...
  CiteTB.nrefParseClick = () => {
    ...
    var _iterator7 = _createForOfIteratorHelper(CiteTB.mainRefList), _step7;
    try {
      for (_iterator7.s(); !(_step7 = _iterator7.n()).done; ) {
        const ref = _step7.value;
  ...
  CiteTB.namedRefSelectClick = () => {
    ...
    var _iterator8 = _createForOfIteratorHelper(CiteTB.mainRefList), _step8;
    try {
      for (_iterator8.s(); !(_step8 = _iterator8.n()).done; ) {
        const ref = _step8.value;
        if (!ref.shorttag && ref.refname === choice) {
...
var refToolbarBase = () => {
  ...
  window.CiteTemplate = class CiteTemplate {
    ...
    makeFormInner(fields, incrsetup) {
      ...
      const autofills = [];
      let tr;
      var _iterator9 = _createForOfIteratorHelper(fields.entries()), _step9;
      try {
        for (_iterator9.s(); !(_step9 = _iterator9.n()).done; ) {
          const [i, fieldobj] = _step9.value;
          let {
            field
          } = fieldobj;
      ...
      if (needsetup || Object.keys(this.incrementables).length === 0) {
        var _iterator10 = _createForOfIteratorHelper(autofills), _step10;
        try {
          for (_iterator10.s(); !(_step10 = _iterator10.n()).done; ) {
            const autofill = _step10.value;
    ...
    getForm() {
      ...
      var _iterator11 = _createForOfIteratorHelper(trs), _step11;
      try {
        for (_iterator11.s(); !(_step11 = _iterator11.n()).done; ) {
          const tr = _step11.value;
          form1.append(tr);
        }
      } catch (err) {
        _iterator11.e(err);
      ...
      var _iterator12 = _createForOfIteratorHelper(trs), _step12;
      try {
        for (_iterator12.s(); !(_step12 = _iterator12.n()).done; ) {
          const tr = _step12.value;
          form2.append(tr);
        }
      } catch (err) {
        _iterator12.e(err);
  ...
  window.CiteErrorCheck = class CiteErrorCheck {
    ...
    run() {
      ...
      switch (this.obj.type) {
        case "refcheck":
          CiteTB.loadRefs();
          var _iterator13 = _createForOfIteratorHelper(CiteTB.mainRefList), _step13;
          try {
            for (_iterator13.s(); !(_step13 = _iterator13.n()).done; ) {
              const ref = _step13.value;
