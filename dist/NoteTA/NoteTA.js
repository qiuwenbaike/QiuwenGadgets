...
var initGlobalMethods = ($body) => {
  ...
  if (WG_SKIN === "vector") {
    ...
    globalMethods.init = () => {
      ...
      $noteTATab = $(noteTATab);
      $noteTATab.removeClass("mw-portlet-".concat(portletId)).addClass(["mw-portlet-".concat(portletId.replace("p-", "")), "vector-menu-tabs"]);
