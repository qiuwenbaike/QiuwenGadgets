    ...
    getPageMode = /* @__PURE__ */ (function() {
      var _ref = _asyncToGenerator(function* (value) {
        ...
        if (WikiplusPages) {
          ...
          if (modes.size === 1) {
            const [mode] = modes, page = pages.length === 1 ? pages[0].title : void 0;
            if (mode === "gadget") {
              return ["javascript", {
                ns: 8
              }];
