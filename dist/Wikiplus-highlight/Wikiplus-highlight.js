...
var init_core = __esm({
  "src/Wikiplus-highlight/src/core.ts"() {
    "use strict";
    import_ext_gadget = require("ext.gadget.codemirror-mediawiki");
    init_dist();
    ({
      wgPageName: page,
    ...
    renderEditor = /* @__PURE__ */ (function() {
      var _ref2 = _asyncToGenerator(function* (target, setting) {
        ...
        const cm = yield import_ext_gadget.CodeMirror6.fromTextArea(target, ...setting ? ["json"] : yield getPageMode(target.value));
...
var init_main = __esm({
  "src/Wikiplus-highlight/src/main.ts"() {
    "use strict";
    init_dist();
    import_ext_gadget2 = require("ext.gadget.codemirror-mediawiki");
    init_core();
    /**!
      ...
      if (!(wphl !== null && wphl !== void 0 && wphl.version)) {
        ...
        const observer = new MutationObserver((records) => {
          ...
          const [removed] = $(records.flatMap(({
            ...
            return [...removedNodes];
          })).find(selector), cm = (_import_ext_gadget2$C = import_ext_gadget2.CodeMirror6.instances) === null || _import_ext_gadget2$C === void 0 ? void 0 : _import_ext_gadget2$C.get(removed);
...
(function WikiplusHighlight() {
  ...
  const loader = /* @__PURE__ */ (function() {
    var _ref4 = _asyncToGenerator(function* () {
      yield (0, import_ext_gadget3.checkDependencies)("Wikiplus");
      const {
