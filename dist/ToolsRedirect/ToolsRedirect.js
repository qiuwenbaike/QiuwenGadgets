...
var ToolsRedirect = {
  ...
  create(pagenames) {
    ...
    void self.bulkEdit(pagenames, getMessage(IS_CATEGORY ? "createtext" : "createtext-category").replace("$1", wgPageName), getMessage("createsummary").replace("$1", wgPageName)).then(() => {
      setTimeout(() => {
