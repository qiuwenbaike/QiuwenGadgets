export const Wikiplus = function () {
	/*! Wikiplus - 4.0.11 | Eridanus Sora (妹空酱) | CC-BY-SA-4.0 <qwbk.cc/H:CC-BY-SA-4.0> */ var t = {
			3099: function (t) {
							...
							stringify: function (t, e, n) {
								...
								if (((r = e), (d(e) || void 0 !== t) && !at(t)))
									return (
										p(e) ||
											(e = function (t, e) {
												if (('function' == typeof r && (e = r.call(this, t, e)), !at(e)))
													return e;
											}),
										(i[1] = e),
										Y.apply(null, i)
				...
				var r = n(2109),
					...
					q = function () {
						...
						var t,
							...
							d = [];
						if (
							(_(l, {type: C, entries: d, updateURL: function () {}, updateSearchParams: U}),
							void 0 !== s)
						)
							if (g(s))
