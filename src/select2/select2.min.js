!((n) => {
	...
	const e = (() => {
			...
			let t, n, r, h, o, s, f, g, m, v, y, _, i, a, w;
			function b(e, t) {
				return i.call(e, t);
			}
			function l(e, t) {
				...
				if (e) {
					for (
						s = (e = e.split('/')).length - 1,
							...
							e[0].charAt(0) === '.' && h && (e = h.slice(0, -1).concat(e)),
							u = 0;
						u < e.length;
						u++
					)
			...
			function A(t, n) {
				return (...args) => {
					const e = a.call(args, 0);
					return typeof e[0] !== 'string' && e.length === 1 && e.push(null), s.apply(h, [...e, t, n]);
				};
			}
			function x(t) {
				return (e) => {
			...
			function c(e) {
				...
				return n > -1 && ((t = e.slice(0, Math.max(0, n))), (e = e.substring(n + 1, e.length))), [t, e];
			}
			function S(e) {
				return e ? c(e) : [];
			}
			return (
				(e && e.requirejs) ||
					...
					(o = (e, t, n, r) => {
						...
						const d = [];
						const p = typeof n;
						if (((c = S((r ||= e))), p == 'undefined' || p == 'function')) {
							for (
				...
				e.define('select2/utils', ['jquery'], (o) => {
					const i = {};
					function u(e) {
						const t = e.prototype,
							n = [];
					...
					(i.Extend = (e, t) => {
						...
						for (const i in t) n.call(t, i) && (e[i] = t[i]);
						...
						(i.Decorate = (r, i) => {
							...
							function o(...args) {
								...
								t > 0 && (e.call(args, r.prototype.constructor), (n = i.prototype.constructor)),
									n.apply(this, args);
							}
							...
							function a(e) {
								...
								return function (...args) {
									return Array.prototype.unshift.call(args, t), n.apply(this, args);
								};
							}
							for (const c of e) {
								o.prototype[c] = a(c);
					...
					(e.prototype.on = function (e, t) {
						...
						(e.prototype.invoke = function (e, t) {
							for (let n = 0, r = e.length; n < r; n++) e[n].apply(this, t);
						}),
						(i.Observable = e),
						(i.generateChars = (e) => {
							for (var t = '', n = 0; n < e; n++) {
							...
							for (const t in e) {
								...
								if (n.length !== 1) {
									for (let i = 0; i < n.length; i++) {
										let o = n[i];
										(o = o.slice(0, 1).toLowerCase() + o.slice(1)) in r || (r[o] = {}),
					...
					let n = 0;
					return (
						(i.GetUniqueElementId = (e) => {
							let t = e.dataset.select2Id;
							return (
								t == null &&
									(e.id
						...
						(i.RemoveData = (e) => {
							...
							i.__cache[t] != null && delete i.__cache[t], e.removeAttribute('data-select2-id');
						}),
						i
					);
				}),
				e.define('select2/results', ['jquery', './utils'], (h, f) => {
					function r(e, t, n) {
					...
					return (
						...
						(r.prototype.render = function () {
							const e = h('<ul class="select2-results__options" role="listbox"></ul>');
							return (
						...
						(r.prototype.displayMessage = function (e) {
							...
							const n = h('<li role="alert" aria-live="assertive" class="select2-results__option"></li>'),
						...
						(r.prototype.highlightFirstItem = function () {
							const e = this.$results.find('.select2-results__option[aria-selected]'),
						...
						(r.prototype.option = function (e) {
							...
							const n = {role: 'option', 'aria-selected': 'false'},
								r =
									window.Element.prototype.matches ||
									window.Element.prototype.msMatchesSelector ||
									window.Element.prototype.webkitMatchesSelector;
							for (const i in (((e.element != null && r.call(e.element, ':disabled')) ||
							...
							this.$results.attr('id', n),
								...
								t.on('results:previous', () => {
									...
									if (!(n <= 0)) {
										...
										r === 0 ? l.$results.scrollTop(0) : s - o < 0 && l.$results.scrollTop(a);
									}
								}),
								t.on('results:next', () => {
									const e = l.getHighlightedResults(),
									...
									if (!(n >= t.length)) {
										...
										const i = l.$results.offset().top + l.$results.outerHeight(!1),
											o = r.offset().top + r.outerHeight(!1),
											s = l.$results.scrollTop() + o - i;
										n === 0 ? l.$results.scrollTop(0) : i < o && l.$results.scrollTop(s);
									}
								}),
						...
						(r.prototype.ensureHighlightVisible = function () {
							...
							if (e.length !== 0) {
								const t = this.$results.find('[aria-selected]').index(e);
								const n = this.$results.offset().top;
								const r = e.offset().top;
								let i = this.$results.scrollTop() + (r - n);
								const o = r - n;
								(i -= 2 * e.outerHeight(!1)),
									t <= 2
				...
				e.define('select2/selection/base', ['jquery', '../utils', '../keys'], (n, r, i) => {
					function o(e, t) {
					...
					return (
						...
						(o.prototype._attachCloseHandler = (e) => {
						...
						(o.prototype._detachCloseHandler = (e) => {
							n(document.body).off(`mousedown.select2.${e.id}`);
						}),
						(o.prototype.position = (e, t) => {
							t.find('.selection').append(e);
						}),
						(o.prototype.destroy = function () {
							this._detachCloseHandler(this.container);
						}),
						(o.prototype.update = (e) => {
							throw new Error('The `update` method must be defined in child classes.');
						}),
						o
					);
				}),
				e.define('select2/selection/single', ['jquery', './base', '../utils', '../keys'], (e, t, n, r) => {
					function i(...args) {
						i.__super__.constructor.apply(this, args);
					}
					return (
						n.Extend(i, t),
						...
						(i.prototype.bind = function (t, e) {
							const n = this;
							Reflect.apply(i.__super__.bind, this, arguments);
				...
				e.define('select2/selection/multiple', ['jquery', './base', '../utils'], (i, e, l) => {
					function n(e, t) {
						Reflect.apply(n.__super__.constructor, this, arguments);
					}
					return (
						l.Extend(n, e),
						...
						(n.prototype.bind = function (e, t) {
							const r = this;
							Reflect.apply(n.__super__.bind, this, arguments),
				...
				e.define('select2/selection/placeholder', ['../utils'], (e) => {
					function t(e, t, n) {
						(this.placeholder = this.normalizePlaceholder(n.get('placeholder'))), e.call(this, t, n);
					}
					return (
						(t.prototype.normalizePlaceholder = (e, t) => {
						...
						(t.prototype.update = function (e, t) {
							...
							this.clear();
							const r = this.createPlaceholder(this.placeholder);
							this.$selection.find('.select2-selection__rendered').append(r);
						}),
						t
					);
				}),
				e.define('select2/selection/allowClear', ['jquery', '../keys', '../utils'], (i, r, a) => {
					function e() {}
					return (
						...
						(e.prototype.update = function (e, t) {
							if (
								(e.call(this, t),
								!(this.$selection.find('.select2-selection__placeholder').length > 0 || t.length === 0))
							) {
								const n = this.options.get('translations').get('removeAllItems'),
				...
				e.define('select2/selection/search', ['jquery', '../utils', '../keys'], (r, a, l) => {
					function e(e, t, n) {
						e.call(this, t, n);
					}
					return (
						...
						(e.prototype.bind = function (e, t, n) {
							...
							e.call(this, t, n),
								...
								this.$selection.on('keydown', '.select2-search--inline', (e) => {
									if (
										...
										const t = r.$searchContainer.prev('.select2-selection__choice');
										if (t.length > 0) {
											const n = a.GetData(t[0], 'data');
							...
							this.$selection.on('input.searchcheck', '.select2-search--inline', (e) => {
								...
								this.$selection.on('keyup.search input.search', '.select2-search--inline', (e) => {
									if (s && e.type === 'input') r.$selection.off('input.search input.searchcheck');
									else {
										const t = e.which;
				...
				e.define('select2/selection/eventRelay', ['jquery'], (s) => {
					function e() {}
					return (
						(e.prototype.bind = function (e, t, n) {
							const r = this,
							...
							e.call(this, t, n),
								t.on('*', (e, t) => {
									if (s.inArray(e, i) !== -1) {
										t ||= {};
										const n = s.Event(`select2:${e}`, {params: t});
										r.$element.trigger(n),
				...
				e.define('select2/translation', ['jquery', 'require'], (t, n) => {
					function r(e) {
						this.dict = e || {};
					}
					return (
				...
				e.define('select2/data/base', ['../utils'], (r) => {
					function n(e, t) {
						n.__super__.constructor.call(this);
					}
					return (
						r.Extend(n, r.Observable),
						(n.prototype.current = (e) => {
							throw new Error('The `current` method must be defined in child classes.');
						}),
						(n.prototype.query = (e, t) => {
							throw new Error('The `query` method must be defined in child classes.');
						}),
						(n.prototype.bind = (e, t) => {}),
						(n.prototype.destroy = () => {}),
						(n.prototype.generateResultId = (e, t) => {
							let n = `${e.id}-result-`;
							return (
								(n += r.generateChars(4)),
								t.id == null ? (n += `-${r.generateChars(4)}`) : (n += `-${t.id.toString()}`),
								n
							);
						}),
						n
				...
				e.define('select2/data/select', ['./base', '../utils', 'jquery'], (e, a, l) => {
					function n(e, t) {
					...
					return (
						...
						(n.prototype._normalizeItem = function (e) {
							...
							return (
								(e = l.extend({}, {text: ''}, e)).id != null && (e.id = e.id.toString()),
				...
				e.define('select2/data/array', ['./select', '../utils', 'jquery'], (e, f, g) => {
					function r(e, t) {
					...
					return (
						...
						(r.prototype.select = function (n) {
							let e = this.$element.find('option').filter((e, t) => {
						...
						(r.prototype.convertToOptions = function (e) {
							...
							for (const element of e) {
								const a = this._normalizeItem(element);
				...
				e.define('select2/data/ajax', ['./array', '../utils', 'jquery'], (e, t, o) => {
					function n(e, t) {
					...
					return (
						...
						(n.prototype.query = function (n, r) {
							...
							const t = o.extend({type: 'GET'}, this.ajaxOptions);
							function e() {
								const e = t.transport(
									t,
									(e) => {
							...
							typeof t.url === 'function' && (t.url = t.url.call(this.$element, n)),
								typeof t.data === 'function' && (t.data = t.data.call(this.$element, n)),
				...
				e.define('select2/data/tags', ['jquery'], (u) => {
					function e(e, t, n) {
						const r = n.get('tags'),
							i = n.get('createTag');
				...
				e.define('select2/data/tokenizer', ['jquery'], (d) => {
					function e(e, t, n) {
					...
					return (
						...
						(e.prototype.query = function (e, t, n) {
							const r = this;
							t.term = t.term || '';
							const i = this.tokenizer(t, this.options, (e) => {
						...
						(e.prototype.tokenizer = function (e, t, n, r) {
							for (
								...
								if (d.inArray(l, i) === -1) {
									...
									const c = o.slice(0, Math.max(0, s)),
										u = a(d.extend({}, t, {term: c}));
									u == null ? s++ : (r(u), (o = o.slice(s + 1) || ''), (s = 0));
								}
							}
							return {term: o};
						}),
				...
				e.define('select2/dropdown', ['jquery', './utils'], (t, e) => {
					function n(e, t) {
						(this.$element = e), (this.options = t), n.__super__.constructor.call(this);
					}
					return (
						...
						(n.prototype.render = function () {
							const e = t('<span class="select2-dropdown"><span class="select2-results"></span></span>');
				...
				e.define('select2/dropdown/search', ['jquery', '../utils'], (o, e) => {
					function t() {}
					return (
				...
				e.define('select2/dropdown/hidePlaceholder', [], () => {
					...
					return (
						...
						(e.prototype.normalizePlaceholder = (e, t) => {
							return typeof t === 'string' && (t = {id: '', text: t}), t;
						}),
						(e.prototype.removePlaceholder = function (e, t) {
							for (var n = [...t], r = t.length - 1; r >= 0; r--) {
								const i = t[r];
				...
				e.define('select2/dropdown/infiniteScroll', ['jquery'], (n) => {
					function e(e, t, n, r) {
						(this.lastParams = {}),
							e.call(this, t, n, r),
					...
					return (
						...
						(e.prototype.loadMoreIfNeeded = function () {
							...
							if (!this.loading && e) {
								const t = this.$results.offset().top + this.$results.outerHeight(!1);
						...
						(e.prototype.showLoadingMore = (e, t) => {
				...
				e.define('select2/dropdown/attachBody', ['jquery', '../utils'], (f, a) => {
					function e(e, t, n) {
					...
					return (
						...
						(e.prototype.position = function (e, t, n) {
							t.attr('class', n.attr('class')),
								...
								t.css({position: 'absolute', top: -999_999}),
								(this.$container = n);
						}),
						(e.prototype.render = function (e) {
							const t = f('<span></span>'),
						...
						(e.prototype._positionDropdown = function () {
							const e = f(window);
							const t = this.$dropdown.hasClass('select2-dropdown--above');
							const n = this.$dropdown.hasClass('select2-dropdown--below');
							let r = null;
							const i = this.$container.offset();
							i.bottom = i.top + this.$container.outerHeight(!1);
							const o = {height: this.$container.outerHeight(!1)};
				...
				e.define('select2/dropdown/selectOnClose', ['../utils'], (o) => {
					function e() {}
					return (
						(e.prototype.bind = function (e, t, n) {
							const r = this;
				...
				e.define(
					...
					(c, u, d, p, h, f, g, m, v, y, s, t, _, $, w, b, A, x, D, S, E, C, O, T, q, L, I, j, e) => {
						function n() {
							this.reset();
						}
						return (
							(n.prototype.apply = function (e) {
								if ((e = c.extend(!0, {}, this.defaults, e)).dataAdapter == null) {
									if (
										(e.ajax == null
											? e.data == null
												...
												: (e.dataAdapter = $)
											: (e.dataAdapter = w),
										e.minimumInputLength > 0 && (e.dataAdapter = y.Decorate(e.dataAdapter, x)),
										e.maximumInputLength > 0 && (e.dataAdapter = y.Decorate(e.dataAdapter, D)),
										e.maximumSelectionLength > 0 && (e.dataAdapter = y.Decorate(e.dataAdapter, S)),
									...
									if (e.initSelection != null) {
										const n = u(`${e.amdBase}compat/initSelection`);
								...
								if (
									(e.resultsAdapter == null &&
										((e.resultsAdapter = d),
										e.ajax != null && (e.resultsAdapter = y.Decorate(e.resultsAdapter, T)),
										e.placeholder != null && (e.resultsAdapter = y.Decorate(e.resultsAdapter, O)),
									...
									if (
										...
										const i = u(`${e.amdBase}compat/dropdownCss`);
								...
								if (e.selectionAdapter == null) {
									if (
										...
										const o = u(`${e.amdBase}compat/containerCss`);
							...
							(n.prototype._resolveLanguage = (e) => {
								...
								for (var n = [], r = 0; r < t.length; r++)
									if ((n.push(t[r]), typeof t[r] === 'string' && t[r].indexOf('-') > 0)) {
										const i = t[r].split('-')[0];
										n.push(i);
									}
								return n;
				...
				e.define('select2/options', ['require', 'jquery', './defaults', './utils'], (r, d, i, p) => {
					function e(e, t) {
						if (
							((this.options = e),
							...
							const n = r(`${this.get('amdBase')}compat/inputData`);
					...
					return (
						(e.prototype.fromElement = function (e) {
							...
							this.options.multiple == null && (this.options.multiple = e.prop('multiple')),
								this.options.disabled == null && (this.options.disabled = e.prop('disabled')),
				...
				e.define('select2/core', ['jquery', './options', './utils', './keys'], (i, c, u, r) => {
					...
					return (
						...
						(d.prototype._generateId = (e) => {
							return `select2-${(e.attr('id') == null
								? e.attr('name') == null
									? u.generateChars(4)
						...
						(d.prototype._placeContainer = function (e) {
							...
							const t = this._resolveWidth(this.$element, this.options.get('width'));
						...
						(d.prototype._resolveWidth = function (e, t) {
							...
							if (t == 'resolve') {
								...
								return r == null ? this._resolveWidth(e, 'element') : r;
							}
							if (t == 'element') {
								const i = e.outerWidth(!1);
								return i <= 0 ? 'auto' : `${i}px`;
							}
							if (t != 'style') return t == 'computedstyle' ? window.getComputedStyle(e[0]).width : t;
							const o = e.attr('style');
							if (typeof o !== 'string') return null;
							for (let s = o.split(';'), a = 0, l = s.length; a < l; a += 1) {
								const c = s[a].replace(/\s/g, '').match(n);
						...
						(d.prototype.data = function (...args) {
							this.options.get('debug') &&
								args.length > 0 &&
								window.console &&
								console.warn &&
				...
				e.define('jquery-mousewheel', ['jquery'], (e) => {
					return e;
				}),
				e.define(
					'jquery.select2',
					...
					(i, e, o, t, s) => {
						if (i.fn.select2 == null) {
							...
							i.fn.select2 = function (t) {
								...
								if (typeof t !== 'string') throw new Error(`Invalid arguments for Select2: ${t}`);
								let n;
