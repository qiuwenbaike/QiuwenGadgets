!((n) => {
	...
	const e = (() => {
			...
			return (
					...
					(i.Extend = (e, t) => {
						...
						(i.Decorate = (r, i) => {
							...
							function o(...args) {
								...
								0 < t && (e.call(args, r.prototype.constructor), (n = i.prototype.constructor)),
									n.apply(this, args);
							}
				...
				e.define('select2/results', ['jquery', './utils'], (h, f) => {
					...
					return (
						...
						(r.prototype.setClasses = function () {
							const t = this;
							this.data.current((e) => {
								const r = h.map(e, ({id}) => id.toString());
						...
						(r.prototype.option = function (e) {
							...
							for (const i in (((null != e.element && r.call(e.element, ':disabled')) ||
						...
						(r.prototype.bind = function (t, e) {
							...
							this.$results.attr('id', n),
								t.on('results:all', ({data}) => {
									l.clear(), l.append(data), t.isOpen() && (l.setClasses(), l.highlightFirstItem());
								}),
								t.on('results:append', ({data}) => {
									l.append(data), t.isOpen() && l.setClasses();
								}),
								t.on('query', (e) => {
								...
								t.on('results:focus', ({element}) => {
									element.addClass('select2-results__option--highlighted');
								}),
				...
				e.define('select2/selection/base', ['jquery', '../utils', '../keys'], (n, r, {SPACE}) => {
					function o(e, t) {
					...
					return (
						...
						(o.prototype.bind = function (e, t) {
							...
							(this.container = e),
								...
								this.$selection.on('keydown', (e) => {
									n.trigger('keypress', e), e.which === SPACE && e.preventDefault();
								}),
								e.on('results:focus', ({data}) => {
									n.$selection.attr('aria-activedescendant', data._resultId);
								}),
								e.on('selection:update', ({data}) => {
									n.update(data);
								}),
								e.on('open', () => {
						...
						(o.prototype._attachCloseHandler = ({id}) => {
							n(document.body).on('mousedown.select2.' + id, ({target}) => {
								const t = n(target).closest('.select2');
								n('.select2.select2-container--open').each(function () {
									this != t[0] && r.GetData(this, 'element').select2('close');
								});
							});
						}),
						(o.prototype._detachCloseHandler = ({id}) => {
							n(document.body).off('mousedown.select2.' + id);
						}),
				...
				e.define('select2/selection/placeholder', ['../utils'], (e) => {
					...
					return (
						...
						(t.prototype.update = function (e, t) {
							const n = 1 == t.length && t[0].id != this.placeholder.id;
					...
					(i, {DELETE, BACKSPACE}, a) => {
						...
						return (
							...
							(e.prototype._handleKeyboardClear = function (e, t, n) {
								n.isOpen() || (t.which != DELETE && t.which != BACKSPACE) || this._handleClear(t);
							}),
					...
					return (
						...
						(e.prototype.bind = function (e, t, n) {
							...
							e.call(this, t, n),
								...
								t.on('results:focus', ({data}) => {
									data._resultId
										? r.$search.attr('aria-activedescendant', data._resultId)
										: r.$search.removeAttr('aria-activedescendant');
								}),
						...
						(e.prototype.createPlaceholder = function (e, {text}) {
							this.$search.attr('placeholder', text);
						}),
						(e.prototype.update = function (e, t) {
				...
				e.define('select2/data/base', ['../utils'], (r) => {
					...
					return (
						...
						(n.prototype.destroy = () => {}),
						(n.prototype.generateResultId = ({id}, {id}) => {
							let n = id + '-result-';
							return (
								(n += r.generateChars(4)),
								null != id ? (n += '-' + id.toString()) : (n += '-' + r.generateChars(4)),
								n
							);
						}),
						n
				...
				e.define('select2/data/select', ['./base', '../utils', 'jquery'], (e, a, l) => {
					...
					return (
						...
						(n.prototype.bind = function (e, t) {
							const n = this;
							(this.container = e).on('select', ({data}) => {
								n.select(data);
							}),
								e.on('unselect', ({data}) => {
									n.unselect(data);
				...
				e.define('select2/data/array', ['./select', '../utils', 'jquery'], (e, f, g) => {
					...
					return (
						...
						(r.prototype.select = function (n) {
							let e = this.$element.find('option').filter((e, {value}) => value == n.id.toString());
				...
				e.define('select2/dropdown/infiniteScroll', ['jquery'], (n) => {
					...
					return (
						...
						(e.prototype.showLoadingMore = (e, {pagination}) => pagination && pagination.more),
				...
				e.define('select2/dropdown/attachBody', ['jquery', '../utils'], (f, a) => {
					...
					return (
						...
						(e.prototype._attachPositioningHandler = function (e, {id}) {
							const n = this,
								r = 'scroll.select2.' + id,
								i = 'resize.select2.' + id,
								o = 'orientationchange.select2.' + id,
						...
						(e.prototype._detachPositioningHandler = function (e, {id}) {
							const n = 'scroll.select2.' + id,
								r = 'resize.select2.' + id,
								i = 'orientationchange.select2.' + id;
				...
				e.define('select2/i18n/en', [], () => {
					return {
						...
						inputTooLong({input, maximum}) {
							const t = input.length - maximum;
							let n = 'Please delete ' + t + ' character';
							return 1 != t && (n += 's'), n;
						},

						inputTooShort({minimum, input}) {
							return 'Please enter ' + (minimum - input.length) + ' or more characters';
						},
						...
						maximumSelected({maximum}) {
							let t = 'You can only select ' + maximum + ' item';
							return 1 != maximum && (t += 's'), t;
						},
				...
				e.define('select2/core', ['jquery', './options', './utils', './keys'], (i, c, u, r) => {
					...
					return (
						...
						(d.prototype.val = function (e) {
							...
							let t = e[0];
							i.isArray(t) && (t = i.map(t, (e) => e.toString())), this.$element.val(t).trigger('change');
						}),
				...
				e.define('jquery-mousewheel', ['jquery'], (e) => e),
				e.define(
					'jquery.select2',
