...
type ApiOpenSearchParams = import('types-mediawiki-renovate/api_params').ApiOpenSearchParams &
	import('types-mediawiki-renovate/api_params').ApiFormatJsonParams;
type ApiOptionsParams = import('types-mediawiki-renovate/api_params').ApiOptionsParams &
	import('types-mediawiki-renovate/api_params').ApiFormatJsonParams;
...
type ApiQueryRevisionsParams = import('types-mediawiki-renovate/api_params').ApiQueryRevisionsParams &
	import('types-mediawiki-renovate/api_params').ApiFormatJsonParams;
type ApiQueryTokensParams = import('types-mediawiki-renovate/api_params').ApiQueryTokensParams &
	import('types-mediawiki-renovate/api_params').ApiFormatJsonParams;
