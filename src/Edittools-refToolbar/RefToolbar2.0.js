...
export const refToolbar2 = function () {
	// Global object
	// TODO:
	...
	if (['edit', 'submit'].includes(mw.config.get('wgAction')) && mw.config.get('wgPageContentModel') === 'wikitext') {
		...
		CiteTB.setupErrorCheck = () => {
			const form = $('<div>')
				.attr('id', 'cite-errorcheck-heading')
				.html(mw.messages.get('cite-errorcheck-heading'));
