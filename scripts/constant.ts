...
const DEPLOY_USER_AGENT =
	'Qiuwen/1.1 (https://www.qiuwenbaike.cn) AnYiEE/AwesomeGadgets (https://github.com/AnYiEE/AwesomeGadgets; i@anyi.in) Qiuwenbaike/QiuwenGadgets (https://github.com/Qiuwenbaike/QiuwenGadgets; adjcom@volunteers.qiuwen.org)' satisfies string;
